...
public class DeliverInfoFragment extends Fragment
{
	...
	private void addContent(String time, String State, LayoutInflater inflater, boolean isTop)
	{
		...
		LinearLayout.LayoutParams llp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getActivity().getResources().getDisplayMetrics()));
		if(isTop)
